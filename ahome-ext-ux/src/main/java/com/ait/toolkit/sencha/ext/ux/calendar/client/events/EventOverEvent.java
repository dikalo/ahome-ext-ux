...
public class EventOverEvent extends EventObject {
    ...
    public EventOverEvent( JavaScriptObject jsObj ) {
        super( jsObj );
    }

    public EventOverEvent( CalendarPanel source, CalendarEvent calendarEvent, Element el, JavaScriptObject nativeEvent ) {
        super( nativeEvent );
        this.source = source;
