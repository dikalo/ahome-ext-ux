...
/**
 * This is a panel subclass that renders a list of available calendars. It is
 * not part of the {@link CalendarPanel} component, but is instead meant to be
 * displayed somewhere else inside of an application layout.
 */
