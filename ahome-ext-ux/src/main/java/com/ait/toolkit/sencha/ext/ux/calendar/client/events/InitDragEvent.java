...
public class InitDragEvent extends EventObject {

    public static String EVENT_NAME = "inidrag";
    ...
    public InitDragEvent( JavaScriptObject jsObj ) {
        super( jsObj );
    }

    public InitDragEvent( CalendarPanel source, JavaScriptObject nativeEvent ) {
        super( nativeEvent );
        this.source = source;
    }
